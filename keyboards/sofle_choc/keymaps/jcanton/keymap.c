...
[_SYMB] = LAYOUT(
    ...
    _______, KC_BRID, KC_BRIU, KC_MCTL, _______, _______,                    _______, KC_LBRC, KC_RBRC, KC_MINS, KC_EQL,  _______,
    KC_CAPS, _______, _______, _______, _______, _______,                    _______, KC_LPRN, KC_RPRN, KC_LT,   KC_GT,   _______,
