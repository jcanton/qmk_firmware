...
[_QWERTY] = LAYOUT(
    ...
    KC_LSFT,  KC_Z,   KC_X,   KC_C,    KC_V,    KC_B, KC_MUTE,               KC_MPLY, KC_N,       KC_M,    KC_COMM, KC_DOT, KC_SLSH, KC_RSFT,
              MT(MOD_LCTL, KC_GRV), KC_LOPT, KC_LCMD, MO(_NAV), LT(_MOUSE, KC_ENT), LT(_NUM, KC_SPC), KC_FUNLEDS, MO(_SYM), MT(MOD_RALT, KC_LBRC), MT(MOD_RCTL, KC_RBRC)
),
[_NAV] = LAYOUT(
    ...
    _______, _______, _______, _______, _______, _______, _______,  _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END,  _______, KC_INS,
              MT(MOD_LCTL, KC_GRV), KC_LOPT, KC_LCMD, MO(_NAV), KC_ENT,          KC_SPC,  KC_FUNLEDS, MO(_NUM), MT(MOD_RALT, KC_LBRC), MT(MOD_RGUI, KC_RBRC)
),
[_MOUSE] = LAYOUT(
